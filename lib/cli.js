...
const titlesFile   = process.env.INPUT  || nodePath.join(__dirname, "../text/titles.txt");
const idsFile      = process.env.IDS    || nodePath.join(__dirname, "../text/ids.csv");
const taglinesFile = process.env.OUTPUT || nodePath.join(__dirname, "../text/taglines.txt");

const yearTitlesMap = require("./year-titles")(titlesFile);
const id2TitleMap = {};
const allTaglines = [];
const errors = [];
